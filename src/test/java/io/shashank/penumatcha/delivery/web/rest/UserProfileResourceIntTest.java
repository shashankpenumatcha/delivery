...
public class UserProfileResourceIntTest {
    ...
    private static final Boolean DEFAULT_CUSTOMER = false;
    private static final Boolean UPDATED_CUSTOMER = true;
    ...
    public void createUserProfile() throws Exception {
        ...
        assertThat(testUserProfile.isCustomer()).isEqualTo(DEFAULT_CUSTOMER);
    }
    ...
    public void getAllUserProfiles() throws Exception {
        ...
        restUserProfileMockMvc.perform(get("/api/user-profiles?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].customer").value(hasItem(DEFAULT_CUSTOMER.booleanValue())));
    }
    ...
    public void getUserProfile() throws Exception {
        ...
        restUserProfileMockMvc.perform(get("/api/user-profiles/{id}", userProfile.getId()))
            ...
            .andExpect(jsonPath("$.customer").value(DEFAULT_CUSTOMER.booleanValue()));
    }
    ...
    public void updateUserProfile() throws Exception {
        ...
        UserProfile testUserProfile = userProfileList.get(userProfileList.size() - 1);
        assertThat(testUserProfile.isCustomer()).isEqualTo(UPDATED_CUSTOMER);
    }
