    ...
    describe('UserProfile Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-profiles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a UserProfile', () => {
                service.create(new UserProfile(null)).subscribe(received => {
            ...
            it('should update a UserProfile', () => {
                service.update(new UserProfile(123)).subscribe(received => {
            ...
            it('should return a UserProfile', () => {
