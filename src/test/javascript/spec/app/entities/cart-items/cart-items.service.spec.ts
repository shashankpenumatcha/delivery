...
describe('Service Tests', () => {
    describe('CartItems Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CartItemsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cart-items';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a CartItems', () => {
                service.create(new CartItems(null)).subscribe(received => {
            ...
            it('should update a CartItems', () => {
                service.update(new CartItems(123)).subscribe(received => {
