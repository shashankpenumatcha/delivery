    ...
    describe('OrderItems Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/order-items';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a OrderItems', () => {
                service.create(new OrderItems(null)).subscribe(received => {
            ...
            it('should update a OrderItems', () => {
                service.update(new OrderItems(123)).subscribe(received => {
